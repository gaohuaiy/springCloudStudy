<template>
    <div>
        <h4 class="lighter">
            ...
            <router-link to="/business/course" href="#modal-wizard" data-toggle="modal" class="pink">{{course.name}}
            </router-link>
            &nbsp;
            <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
            <router-link to="/business/course" href="#modal-wizard" data-toggle="modal" class="pink">{{chapter.name}}
            </router-link>
        </h4>
        <p>
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <file  v-bind:use="FILE_USE.COURSE.key"
                                          v-bind:text="'上传视频'"
                                    ...
                                    <div v-show="section.video" class="row">
                                        <div class="col-md-9">
                                            <video ref="video" v-bind:src="section.video" controls="controls"></video>
                                        </div>
                                    </div>
                                </div>
