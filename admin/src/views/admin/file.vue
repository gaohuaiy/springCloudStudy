  ...
  export default {
    ...
    methods: {
      ...
      list(page) {
        let _this = this;
        Loading.show();
        _this.$axios.post(process.env.VUE_APP_SERVER + '/business/admin/file/list', {
          page: page,
      ...
      save() {
        ...
        Loading.show();
        _this.$axios.post(process.env.VUE_APP_SERVER + '/business/admin/file/save', _this.file).then((response)=>{
          Loading.hide();
          let resp = response.data;
          if (resp.success) {
      ...
      del(id) {
        ...
        Confirm.show("删除文件后不可恢复，确认删除？", function () {
          Loading.show();
          _this.$axios.delete(process.env.VUE_APP_SERVER + '/business/admin/file/delete/' + id).then((response)=>{
            Loading.hide();
            let resp = response.data;
            if (resp.success) {
              _this.list(1);
